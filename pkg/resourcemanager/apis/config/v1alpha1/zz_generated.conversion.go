...
func autoConvert_v1alpha1_ResourceManagerConfiguration_To_config_ResourceManagerConfiguration(in *ResourceManagerConfiguration, out *config.ResourceManagerConfiguration, s conversion.Scope) error {
	if err := Convert_v1alpha1_SourceClientConnection_To_config_SourceClientConnection(&in.SourceClientConnection, &out.SourceClientConnection, s); err != nil {
		return err
	}
	if in.TargetClientConnection != nil {
		in, out := &in.TargetClientConnection, &out.TargetClientConnection
		*out = new(config.TargetClientConnection)
		if err := Convert_v1alpha1_TargetClientConnection_To_config_TargetClientConnection(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_config_ResourceManagerConfiguration_To_v1alpha1_ResourceManagerConfiguration(in *config.ResourceManagerConfiguration, out *ResourceManagerConfiguration, s conversion.Scope) error {
	if err := Convert_config_SourceClientConnection_To_v1alpha1_SourceClientConnection(&in.SourceClientConnection, &out.SourceClientConnection, s); err != nil {
		return err
	}
	if in.TargetClientConnection != nil {
		in, out := &in.TargetClientConnection, &out.TargetClientConnection
		*out = new(TargetClientConnection)
		if err := Convert_config_TargetClientConnection_To_v1alpha1_TargetClientConnection(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.TargetClientConnection = nil
...
func autoConvert_v1alpha1_SourceClientConnection_To_config_SourceClientConnection(in *SourceClientConnection, out *config.SourceClientConnection, s conversion.Scope) error {
...
func Convert_v1alpha1_SourceClientConnection_To_config_SourceClientConnection(in *SourceClientConnection, out *config.SourceClientConnection, s conversion.Scope) error {
	return autoConvert_v1alpha1_SourceClientConnection_To_config_SourceClientConnection(in, out, s)
}

func autoConvert_config_SourceClientConnection_To_v1alpha1_SourceClientConnection(in *config.SourceClientConnection, out *SourceClientConnection, s conversion.Scope) error {
...
func autoConvert_v1alpha1_TargetClientConnection_To_config_TargetClientConnection(in *TargetClientConnection, out *config.TargetClientConnection, s conversion.Scope) error {
	if err := configv1alpha1.Convert_v1alpha1_ClientConnectionConfiguration_To_config_ClientConnectionConfiguration(&in.ClientConnectionConfiguration, &out.ClientConnectionConfiguration, s); err != nil {
		return err
	}
	out.Namespace = (*string)(unsafe.Pointer(in.Namespace))
...
func Convert_v1alpha1_TargetClientConnection_To_config_TargetClientConnection(in *TargetClientConnection, out *config.TargetClientConnection, s conversion.Scope) error {
	return autoConvert_v1alpha1_TargetClientConnection_To_config_TargetClientConnection(in, out, s)
}

func autoConvert_config_TargetClientConnection_To_v1alpha1_TargetClientConnection(in *config.TargetClientConnection, out *TargetClientConnection, s conversion.Scope) error {
	if err := configv1alpha1.Convert_config_ClientConnectionConfiguration_To_v1alpha1_ClientConnectionConfiguration(&in.ClientConnectionConfiguration, &out.ClientConnectionConfiguration, s); err != nil {
		return err
	}
	out.Namespace = (*string)(unsafe.Pointer(in.Namespace))
...
func Convert_config_TargetClientConnection_To_v1alpha1_TargetClientConnection(in *config.TargetClientConnection, out *TargetClientConnection, s conversion.Scope) error {
	return autoConvert_config_TargetClientConnection_To_v1alpha1_TargetClientConnection(in, out, s)
}
