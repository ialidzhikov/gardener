...
// TODO: The etcd_db_total_size_in_bytes metric is renamed to apiserver_storage_db_total_size_in_bytes in K8s 1.26. Remove this metric when we remove support for K8s 1.26.
