...
# TODO: Add kubeconfig check that ensure a kubeconfig stored before DR works after the restore.
# TODO: Check Secrets with the persist=true label do not change.
